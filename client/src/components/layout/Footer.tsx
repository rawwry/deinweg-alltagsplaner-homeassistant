        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2.5 text-center sm:text-left">
          <div className="flex items-center gap-1.5 flex-wrap justify-center sm:justify-start">
            ...
            <button
              ...
              className="px-1.5 py-0.5 rounded-md bg-slate-800 hover:bg-slate-750 text-slate-300 hover:text-white font-mono text-[11px] border border-slate-700/60 font-medium transition-colors cursor-pointer"
            >
              v{APP_VERSION}
            </button>
            <span>·</span>
