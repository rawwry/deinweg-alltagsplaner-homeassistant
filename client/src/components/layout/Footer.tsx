...
export const Footer: React.FC = () => {
  ...
  return (
    <>
      <footer className="w-full border-t border-surface-border bg-surface-base/95 backdrop-blur-md py-3 px-4 sm:px-6 lg:px-8 text-xs text-slate-400 flex-shrink-0 z-20">
